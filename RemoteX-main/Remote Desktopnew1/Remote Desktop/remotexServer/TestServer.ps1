# cd Desktop\Remotex\Server\; IEX (Get-Content .\TestServer.ps1 -Raw -Encoding UTF8)
...
Invoke-Expression -Command (Get-Content "Remotex_Server.psm1" -Raw)
...
switch ($scenario)
{
    2 
    { 
        Invoke-RemotexServer -Password $password -EncodedCertificate $pwdProtectedEncodedCertificate -CertificatePassword (ConvertTo-SecureString -String "hello" -AsPlainText -Force)
    } 

    3 
    {
        Invoke-RemotexServer -Password $password
    }
    ...
    4 
    {
        ...
        Invoke-RemotexServer -Password $password -UseTLSv1_3
    }
    ...
    5 
    {
        ...
        Invoke-RemotexServer -Password $password -DisableVerbosity -ViewOnly -PreventComputerToSleep
    }
    ...
    6 
    {
        ...
        Invoke-RemotexServer -Password $password -EncodedCertificate $encodedCertificate -Clipboard "Receive"
    }
    ...
    7 
    {
        ...
        Invoke-RemotexServer -Password $password -EncodedCertificate $encodedCertificate -Clipboard "Send"
    }
    ...
    8 
    {
        ...
        Invoke-RemotexServer -Password $password -EncodedCertificate $encodedCertificate -Clipboard "Disabled"
    }

    default 
    { 
        Invoke-RemotexServer -SecurePassword (ConvertTo-SecureString -String $password -AsPlainText -Force) -EncodedCertificate $encodedCertificate
    }
} 